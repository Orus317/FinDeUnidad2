...
Lectores.Agregar("112", "Palacios", "Maria", "Av. Argentina", "F", 19);
Lectores.Agregar("113", "Durand", "Jose", "Av. Cusco", "M", 20);
Lectores.Agregar("114", "De los Rios", "Andric", "Av. Manco", "F", 21);
Lectores.Agregar("115", "Quispe", "Fernando", "Av. Oreo", "M", 22);
Lectores.Agregar("116", "Puma", "Lia", "Av. Zulha", "F", 23);
Lectores.Agregar("117", "Espinoza", "Ian", "Av. Lima", "M", 24);
Lectores.Agregar("118", "Mamamni", "Wilse", "Av. 2 de mayo", "F", 25);
...
Prestamos.Agregar("2001", "01/01/2020", "1001", "111", Lectores);
Prestamos.Agregar("2002", "02/01/2020", "1002", "112", Lectores);
Prestamos.Agregar("2003", "12/02/2020", "1003", "113", Lectores);
Prestamos.Agregar("2004", "01/05/2020", "1004", "114", Lectores);
Prestamos.Agregar("2005", "14/06/2020", "1005", "115", Lectores);
Prestamos.Agregar("2006", "19/02/2021", "1006", "116", Lectores);
Prestamos.Agregar("2007", "01/09/2021", "1007", "117", Lectores);
Prestamos.Agregar("2008", "11/07/2021", "1008", "118", Lectores);
Prestamos.Agregar("2009", "01/12/2021", "1009", "118", Lectores);
Prestamos.Agregar("2010", "01/06/2021", "1010", "111", Lectores);
Prestamos.Agregar("2011", "11/07/2021", "1011", "111", Lectores);
Prestamos.Agregar("2012", "01/07/2021", "1012", "112", Lectores);
Prestamos.Agregar("2013", "13/07/2021", "1013", "113", Lectores);
Prestamos.Agregar("2014", "27/07/2021", "1014", "114", Lectores);
Prestamos.Agregar("2015", "15/05/2021", "1015", "115", Lectores);
Prestamos.Agregar("2016", "13/03/2021", "1006", "116", Lectores);
Prestamos.Agregar("2017", "10/03/2021", "1007", "117", Lectores);
Prestamos.Agregar("2018", "04/06/2022", "1008", "118", Lectores);
Prestamos.Agregar("2019", "04/04/2022", "1009", "118", Lectores);
Prestamos.Agregar("2020", "05/12/2022", "1010", "111", Lectores);
Prestamos.Agregar("2021", "05/03/2022", "1011", "112", Lectores);
Prestamos.Agregar("2022", "19/01/2022", "1013", "113", Lectores);
Prestamos.Agregar("2023", "23/11/2022", "1014", "114", Lectores);
Prestamos.Agregar("2024", "23/01/2022", "1015", "115", Lectores);
Prestamos.Agregar("2025", "05/09/2022", "1016", "116", Lectores);
Prestamos.Agregar("2026", "05/07/2022", "1017", "117", Lectores);
Prestamos.Agregar("2027", "04/09/2022", "1018", "118", Lectores);
Prestamos.Agregar("2028", "04/05/2022", "1019", "118", Lectores);
Prestamos.Agregar("2029", "04/07/2022", "1010", "111", Lectores);
Prestamos.Agregar("2030", "12/06/2022", "1011", "111", Lectores);
Prestamos.Agregar("2031", "06/06/2022", "1012", "112", Lectores);
Prestamos.Agregar("2032", "02/07/2022", "1013", "113", Lectores);
Prestamos.Agregar("2033", "04/06/2022", "1014", "114", Lectores);
Prestamos.Agregar("2034", "02/08/2022", "1015", "115", Lectores);
Prestamos.Agregar("2035", "03/07/2022", "1006", "116", Lectores);
Prestamos.Agregar("2036", "01/08/2022", "1007", "117", Lectores);
Prestamos.Agregar("2037", "28/10/2022", "1008", "118", Lectores);
Prestamos.Agregar("2038", "21/11/2022", "1009", "118", Lectores);
Prestamos.Agregar("2039", "11/12/2022", "1010", "111", Lectores);
Prestamos.Agregar("2040", "01/12/2022", "1011", "111", Lectores);
